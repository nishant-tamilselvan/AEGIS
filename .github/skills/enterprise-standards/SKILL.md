...
steps are in [`docs/enterprise-standards-setup.md`](../../../docs/enterprise-standards-setup.md).
...
- Setup guide, tool contract and document schema:
  [`docs/enterprise-standards-setup.md`](../../../docs/enterprise-standards-setup.md).
- Server config templates: [`../../../.vscode/mcp.example.json`](../../../.vscode/mcp.example.json)
  for VS Code and [`../../../.mcp.example.json`](../../../.mcp.example.json) for Claude Code
