---
# Generated from aegis/agents/implementation-orchestrator.md by scripts/sync_platforms.py. Edit the source, not this file.
...
tools: [read, search, execute, todo, agent, 'enterprise-standards-server/*']
handoffs:
