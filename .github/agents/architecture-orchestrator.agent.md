---
# Generated from aegis/agents/architecture-orchestrator.md by scripts/sync_platforms.py. Edit the source, not this file.
...
tools: [read, search, edit, todo, agent, 'enterprise-standards-server/*']
handoffs:
