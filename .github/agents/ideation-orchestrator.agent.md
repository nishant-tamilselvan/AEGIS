---
# Generated from aegis/agents/ideation-orchestrator.md by scripts/sync_platforms.py. Edit the source, not this file.
...
tools: [read, agent, edit, search, 'enterprise-standards-server/*', todo]
handoffs:
  - label: "Architecture"
