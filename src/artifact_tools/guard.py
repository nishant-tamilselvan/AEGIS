...
def _normalise_agent(value: object) -> str:
    # Plugin agents are namespaced ("aegis:service-implementer"); compare the bare name so
    # a plugin install is guarded like a clone. Another plugin reusing an implementer's
    # name only makes that agent more restricted, never less.
