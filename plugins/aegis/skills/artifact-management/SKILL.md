...
[`docs/artifacts/README.md`](https://github.com/nishant-tamilselvan/AEGIS/blob/main/docs/artifacts/README.md).
...
- **New application?** Choose a short kebab-case slug for the folder, scaffold into it,
  and add a row to [`docs/artifacts/README.md`](https://github.com/nishant-tamilselvan/AEGIS/blob/main/docs/artifacts/README.md).
